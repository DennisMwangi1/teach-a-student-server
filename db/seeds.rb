...
puts "seeding database"
    ...
    Request.create(parent_id:p1.id,teacher_id:t1.id)
    Request.create(parent_id:p1.id,teacher_id:t2.id)
    Request.create(parent_id:p2.id,teacher_id:t1.id)
    Request.create(parent_id:p2.id,teacher_id:t2.id)
    Request.create(parent_id:p3.id,teacher_id:t3.id)
    Request.create(parent_id:p3.id,teacher_id:t4.id)
    Request.create(parent_id:p4.id,teacher_id:t3.id)
    Request.create(parent_id:p4.id,teacher_id:t4.id)

    Session.create(student_id:s1.id,teacher_id:t1.id)
    Session.create(student_id:s1.id,teacher_id:t2.id)
    Session.create(student_id:s2.id,teacher_id:t1.id)
    Session.create(student_id:s2.id,teacher_id:t2.id)
    Session.create(student_id:s3.id,teacher_id:t3.id)
    Session.create(student_id:s3.id,teacher_id:t4.id)
    Session.create(student_id:s4.id,teacher_id:t3.id)
    Session.create(student_id:s4.id,teacher_id:t4.id)
